...
public class HistoryRowV2DTO {
    ...
    public HistoryRowV2DTO(int runNumber, int degree, long result, long totalCycles, Map<String, Long> variablesToValuesSorted, List<Long> inputsValues) {
