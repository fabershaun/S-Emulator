...
import instruction.*;
import engine.logic.instruction.synthetic.functionInstructionsUtils.FunctionExecutionResult;
...
import static engine.logic.instruction.synthetic.functionInstructionsUtils.FunctionExecutionResult.addFunctionArgumentCycles;
import static engine.logic.instruction.synthetic.functionInstructionsUtils.FunctionExecutionResult.extractInputValues;
import static engine.logic.instruction.synthetic.functionInstructionsUtils.FunctionInstructionUtils.buildCommandArguments;
import static engine.logic.instruction.synthetic.functionInstructionsUtils.FunctionInstructionUtils.getInputs;
